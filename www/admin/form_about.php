    ...
    <form class="form" id="formAbout">
            ...
            <div class="container grid-body gutter-bot-s">
                <div class="span__full">
                    <div class="form__input-group gutter-bot-m">
                        <div class="input-wrapper">
                            <textarea class="textarea item-headline" name="aboutTitle" id="aboutTitle" required><?= $jContent->title->text ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="span__4 span__6_m offset__1_m span__8_l offset__2_l">
                    <div class="form__input-group gutter-bot-xs">
                        <label class="label" for="">Youtube video URL</label>
                        <div class="input-wrapper">
                            <input class="input bodytext" name="videoLink" id="videoLink" value="<?= $jContent->video->url ?>" required>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container grid-body">
                <div class="span__4">
                    <div class="gutter-bot-s">
                        ...
                        <div class="form__input-group margin-top-s gutter-bot-m">
                ...
                <div class="span__4 span__8_m span__4_l">
                    <div>
                        <div>
                            <div class="form__input-group">
                                <div class="input-wrapper">
                                    <textarea class="textarea title" name="partnershipsTitle" id="partnershipsTitle" required><?= $jContent->sec_partnership_triangle->title->text ?></textarea>
                                </div>
                            </div>
                    ...
                    <div class="subgrid-2-col">
                        <div class="span__4">
                            <div class="gutter-bot-m">
                                <div>
                                    <div class="form__input-group margin-bot-xs">
                                        <label class="label" for="">Heading</label>
                                        <div class="input-wrapper">
                                            <input class="input item-headline" name="partnerName1" id="partnerName1" value="<?= $jContent->sec_partnership_triangle->partners->partner_1->heading->text ?>" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form__input-group margin-top-xs gutter-bot-xs">
                                    <label class="label" for="">Content</label>
                                    <div class="input-wrapper">
                                        <textarea class="textarea bodytext" name="partnerBio1" id="partnerBio1" required><?= $jContent->sec_partnership_triangle->partners->partner_1->bio->text ?></textarea>
                                    </div>
                                </div>
                                <div class="form__input-group">
                                    <label class="label" for="">Link</label>
                                    <div class="input-wrapper">
                                        <input class="input bodytext" name="partnerLink1" id="partnerLink1" value="<?= $jContent->sec_partnership_triangle->partners->partner_1->link->url ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="gutter-bot-m">
                                <div>
                                    <div class="form__input-group margin-bot-xs">
                                        <label class="label" for="">Heading</label>
                                        <div class="input-wrapper">
                                            <input class="input item-headline" name="partnerName2" id="partnerName2" value="<?= $jContent->sec_partnership_triangle->partners->partner_2->heading->text ?>" required>
                                        </div>
                                    </div>
                                    <div class="underline-container undrln__left">
                                        <div class="undrln__prim underline-inline undrln__s"></div>
                                ...
                                <div class="form__input-group margin-top-xs gutter-bot-xs">
                                    <label class="label" for="">Content</label>
                                    <div class="input-wrapper">
                                        <textarea class="textarea bodytext" name="partnerBio2" id="partnerBio2" required><?= $jContent->sec_partnership_triangle->partners->partner_2->bio->text ?></textarea>
                                    </div>
                                </div>
                                <div class="form__input-group">
                                    <label class="label" for="">Link</label>
                                    <div class="input-wrapper">
                                        <input class="input bodytext" name="partnerLink2" id="partnerLink2" value="<?= $jContent->sec_partnership_triangle->partners->partner_2->link->url ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="gutter-bot-m">
                                <div>
                                    <div class="form__input-group margin-bot-xs">
                                        <label class="label" for="">Heading</label>
                                        <div class="input-wrapper">
                                            <input class="input item-headline" name="partnerName3" id="partnerName3" value="<?= $jContent->sec_partnership_triangle->partners->partner_3->heading->text ?>" required>
                                        </div>
                                    </div>
                                    <div class="underline-container undrln__left">
                                        <div class="undrln__prim underline-inline undrln__s"></div>
                                ...
                                <div class="form__input-group margin-top-xs gutter-bot-xs">
                                    <label class="label" for="">Content</label>
                                    <div class="input-wrapper">
                                        <textarea class="textarea bodytext" name="partnerBio3" id="partnerBio3" required><?= $jContent->sec_partnership_triangle->partners->partner_3->bio->text ?></textarea>
                                    </div>
                                </div>
                                <div class="form__input-group">
                                    <label class="label" for="">Link</label>
                                    <div class="input-wrapper">
                                        <input class="input bodytext" name="partnerLink3" id="partnerLink3" value="<?= $jContent->sec_partnership_triangle->partners->partner_3->link->url ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="section gutter-bot-xl gutter-top-l">
            <div class="container grid-body">
                ...
                <button id="aboutFormSubmit" class="btn btn-block btn-prim span__4 span__6_l">Save</button>
            </div>
        </section>
    </form>
</div>
