...
<div class="wrapper">
    <section class="hero hero__subpage volunteers">
        ...
        <section class="section section-dark">
            <div class="container grid-body">
                <div class="span__4 span__8_m span__4_l">
                    <div>
                        <div>
                            <h5 class="subtitle">Your help</h5>
                            <h2 class="title"><?= $jContent->sec_help->title->text ?></h2>
                            <div class="underline-container undrln__left">
                                <div class="undrln__prim underline-inline undrln__l"></div>
                            </div>
                        </div>
                        ...
                        <div class="span__4">
                            <div class="gutter-bot-m margin-top-s">
                                <div>
                                    ...
                                    <h4 class="item-headline margin-top-s"><?= $jContent->sec_help->helps->help_1->heading->text ?></h4>
                        ...
                        <div class="span__4">
                            <div class="gutter-bot-m margin-top-s">
                                <div>
                                    ...
                                    <h4 class="item-headline margin-top-s"><?= $jContent->sec_help->helps->help_2->heading->text ?></h4>
                                    <div class="underline-container">
                                        <div class="undrln__prim underline-inline undrln__s undrln__left"></div>
                                    </div>
                                </div>
                        ...
                        <div class="span__4">
                            <div class="gutter-bot-m">
                                <div>
                                    ...
                                    <h4 class="item-headline margin-top-s"><?= $jContent->sec_help->helps->help_3->heading->text ?></h4>
                                    <div class="underline-container">
                                        <div class="undrln__prim underline-inline undrln__s undrln__left"></div>
                                    </div>
                                </div>
                        ...
                        <div class="span__4">
                            <div class="gutter-bot-m">
                                <div>
                                    ...
                                    <h4 class="item-headline margin-top-s"><?= $jContent->sec_help->helps->help_4->heading->text ?></h4>
                                    <div class="underline-container">
                                        <div class="undrln__prim underline-inline undrln__s undrln__left"></div>
                                    </div>
                                </div>
