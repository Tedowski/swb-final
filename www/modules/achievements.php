    ...
    <div class="grid-body">
        ...
        <div class="span__4">
            <div>
                ...
                <p><?= nl2br($jAchievements->achievements->achievement_1->content->text) ?></p>
            </div>
        </div>
        <div class="span__4">
            <div>
                ...
                <p><?= nl2br($jAchievements->achievements->achievement_2->content->text) ?></p>
            </div>
        </div>
        <div class="span__4 span__8_m span__4_l">
            <div>
                ...
                <p><?= nl2br($jAchievements->achievements->achievement_3->content->text) ?></p>
            </div>
        </div>
